...
;Dieser Code ist für ein Druckbett von 200x200mm geschrieben worden.
...
;----nächster Punkt----
G1 Z1.0
G1 X180 Y20  ;X=180 und Y=20 Hier die 180mm ggf. anpassen
G1 Z0.3
M1 Klicken -> Weiter
;----nächster Punkt----
G1 Z1.0
G1 X180 Y180 ;X=180 und Y=180 Hier die 180mm ggf. anpassen
G1 Z0.3
M0 Klicken -> Weiter
;----nächster Punkt----
G1 Z1.0
G1 X20 Y180  ;X=20 und Y=180 Hier die 180mm ggf. anpassen
G1 Z0.3
M0 Klicken -> Weiter
;----Abschluss Mittelpunkt----
G1 Z1.0
G1 X100 Y100 ;X=100 und Y=100 Hier die 100mm ggf. anpassen
G1 Z0.3
M0 Klicken -> Ende
;Heizung abschalten
M104 S0   ;Düse aus
