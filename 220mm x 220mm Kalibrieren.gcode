...
;----nächster Punkt----
G1 Z1.0
G1 X200 Y20  ;X=200 und Y=20 Hier die 200mm ggf. anpassen
G1 Z0.3
M1 Klicken -> Weiter
;----nächster Punkt----
G1 Z1.0
G1 X200 Y200 ;X=200 und Y=200 Hier die 200mm ggf. anpassen
G1 Z0.3
M0 Klicken -> Weiter
;----nächster Punkt----
G1 Z1.0
G1 X20 Y200  ;X=20 und Y=200 Hier die 200mm ggf. anpassen
G1 Z0.3
M0 Klicken -> Weiter
;----Abschluss Mittelpunkt----
G1 Z1.0
G1 X110 Y110 ;X=110 und Y=110 Hier die 110mm ggf. anpassen
G1 Z0.3
M0 Klicken -> Ende
;Heizung abschalten
M104 S0   ;Düse aus
